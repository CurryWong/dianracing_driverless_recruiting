...
class SuanRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SuanRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SuanRequest
    let len;
    let data = new SuanRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SuanRequest(null);
    if (msg.a !== undefined) {
      resolved.a = msg.a;
    }
    else {
...
class SuanResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SuanResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SuanResponse
    let len;
    let data = new SuanResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SuanResponse(null);
...
module.exports = {
  Request: SuanRequest,
  Response: SuanResponse,
  md5sum() { return 'eccb72520f9288ba7471164786064905'; },
  datatype() { return 'do_math/Suan'; }
};
